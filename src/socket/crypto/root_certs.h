#ifndef VENOK_ROOT_CERTS_H
#define VENOK_ROOT_CERTS_H

/* Maintaining the root certificates
 *
 * `src/crypto/root_certs.h` contains a compiled-in set of root certificates
 * used as trust anchors for TLS certificate validation.
 *
 ...
 * * Running `generate-ca-bundle.pl` to convert the certificates and generate `src/crypto/root_certs.h`.
 * * Using `git diff-files` to determine which certificate have been added and/or removed.
 */

#include "../internal/internal.h"
static struct v_cert_string root_certs[] = {
